...
class _MessageVoiceNoteState extends State<MessageVoiceNote> {
  ...
  Widget build(BuildContext context) {
    ...
    final progress = totalDuration.inSeconds > 0 ? _position.inSeconds / totalDuration.inSeconds : 0.0;
    final isOutgoing = false; // handled by parent
