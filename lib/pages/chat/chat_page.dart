            ...
            _attachOption(Icons.radio_button_checked, 'Vídeo circular',
              ...
              final result = await TDLibClient.sendRaw({
                ...
                'inputMessageContent': {
                  ...
                  'videoNote': {'@type': 'inputFileLocal', 'path': picked.path},
                  'duration': 0,
                  'length': 0,
                  'selfDestructType': {
                    '@type': 'messageSelfDestructTypeTimer',
                    'selfDestructTime': 86400,
                  },
                },
              });
              ...
              if (result == null) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text('Vídeo circular não suportado nesta versão do TDLib.'),
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text('Vídeo circular enviado! Some em 24h.'),
                      backgroundColor: Color(0xFF00BFA5)),
                );
              }
            }),
