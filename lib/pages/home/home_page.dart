...
import 'package:nullgram/pages/home/zap_story_page.dart';
            ...
            child: Row(
              ...
              children: [
                _NavItem(
                  ...
                  label: 'Chats',
                  isActive: _bottomIndex == 0,
                  onTap: () => setState(() => _bottomIndex = 0),
                ),
                _NavItem(
                  icon: Icons.auto_stories_outlined,
                  iconActive: Icons.auto_stories_rounded,
                  label: 'ZapStory',
                  isActive: _bottomIndex == 1,
          ...
          children: [
            AnimatedSwitcher(
              ...
              child: Icon(
                ...
                color: isActive ? _kGreen : const Color(0xFF888888),
                size: 26,
              ),
            ),
...
class _SearchChatTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final memberCount =
        chat['supergroup']?['memberCount'] ?? chat['memberCount'] ?? 0;
