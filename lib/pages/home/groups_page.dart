...
class _GroupsPageState extends State<GroupsPage> {
  ...
  final List<Map<String, dynamic>> _categories = [
    {'name': 'Amizades',   'icon': '😊', 'queries': ['amizadesbr', 'grupoamizade', 'amizades'],        'color': Color(0xFFFF8A65)},
    {'name': 'Encontros',  'icon': '🤝', 'queries': ['encontrosbrasil', 'encontros', 'relacionamento'], 'color': Color(0xFF42A5F5)},
    {'name': 'Cidades',    'icon': '🌐', 'queries': ['saopaulocidade', 'riodejaneiro', 'brasilia'],     'color': Color(0xFF26A69A)},
    {'name': 'Cultura',    'icon': '🎭', 'queries': ['culturabr', 'literaturabrasileira', 'cultura'],   'color': Color(0xFFAB47BC)},
    ...
    {'name': 'Educação',   'icon': '📚', 'queries': ['educacaobr', 'vestibular', 'concursos'],          'color': Color(0xFF5C6BC0)},
    {'name': 'Esportes',   'icon': '⚽', 'queries': ['futebolbrasil', 'esportesbr', 'futebol'],         'color': Color(0xFF66BB6A)},
    {'name': 'Música',     'icon': '🎵', 'queries': ['musicabrasil', 'musicabr', 'sertanejo'],          'color': Color(0xFFEC407A)},
    ...
    {'name': 'Games',      'icon': '🎮', 'queries': ['gamesbrasil', 'gamersbr', 'freefire'],            'color': Color(0xFF7E57C2)},
  ];
