...
class _GroupsPageState extends State<GroupsPage> {
  ...
  final List<Map<String, dynamic>> _categories = [
    {'name': 'Amizades',   'icon': '😊', 'query': 'amizades',    'color': Color(0xFFFF8A65)},
    {'name': 'Encontros',  'icon': '🤝', 'query': 'encontros',   'color': Color(0xFF42A5F5)},
    {'name': 'Cidades',    'icon': '🌐', 'query': 'cidade',      'color': Color(0xFF26A69A)},
    {'name': 'Cultura',    'icon': '🎭', 'query': 'cultura',     'color': Color(0xFFAB47BC)},
    {'name': 'Cinema',     'icon': '🎬', 'query': 'cinema',      'color': Color(0xFFEF5350)},
    {'name': 'Diversão',   'icon': '🍺', 'query': 'humor',       'color': Color(0xFFFFCA28)},
    {'name': 'Educação',   'icon': '📚', 'query': 'educacao',    'color': Color(0xFF5C6BC0)},
    {'name': 'Esportes',   'icon': '⚽', 'query': 'futebol',     'color': Color(0xFF66BB6A)},
    {'name': 'Música',     'icon': '🎵', 'query': 'musica',      'color': Color(0xFFEC407A)},
    {'name': 'Tecnologia', 'icon': '💻', 'query': 'programacao', 'color': Color(0xFF29B6F6)},
    {'name': 'Negócios',   'icon': '💼', 'query': 'negocios',    'color': Color(0xFF8D6E63)},
    {'name': 'Games',      'icon': '🎮', 'query': 'games',       'color': Color(0xFF7E57C2)},
  ];
...
class _GroupResultsPageState extends State<_GroupResultsPage> {
  ...
  Future<void> _search() async {
    ...
    try {
      ...
      if (mounted) setState(() { _groups = results ?? []; _isLoading = false; });
    } catch (e) {
      if (mounted) setState(() {
